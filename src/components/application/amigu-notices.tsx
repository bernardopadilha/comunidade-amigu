...
export function Notices() {
  return (
    <aside className="shrink-0 max-h-full hidden 2xl:block sticky top-20 w-80 bg-post/80 backdrop-blur-sm border-2 border-zinc-800 rounded-lg ">
      <div className="p-4 border-b-2 border-b-zinc-800 ">
        {/* <Skeleton className="w-40 h-8" /> */}
        <h1 className="text-xl font-semibold text-zinc-100">AmiGU Notícias</h1>
      </div>
      ...
      <div className="py-2 px-4 space-y-4">
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              <p>
                Google anuncia funções anti-roubo no Android primeiro no Brasil
              </p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              <p>
                Fundos de investimentos: saques superam aplicações em R$ 8,8 bi
              </p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              <p>
                Pix tem 5º vazamento no ano; agora, com 20 mil chaves expostas,
                diz BC
              </p>
            </TooltipContent>
          </Tooltip>
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              <p>
                IPCA: inflação oficial sobe 0,46% em maio e avança a 3,93% em 12
                meses
              </p>
            </TooltipContent>
          </Tooltip>
